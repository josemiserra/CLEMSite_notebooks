function peaks = detectPeaks(varargin)
%FindPEAKS Identify peaks after SOFT transform.
%   PEAKS = detectPeaks(H,NUMPEAKS) locates peaks in the sinogram 
%   transform matrix, H, generated by the projection function. NUMPEAKS 
...
%
%   PEAKS = detectPeaks(...,PARAM1,VAL1,PARAM2,VAL2) sets various 
