...
class GeneratorDialog(QtGui.QDialog, Dlg):
    ...
    def clickTL(self):
        ...
        if self.debugging:
           ...
           self.coords[0,:] = [0.0227587628, 0.037982, 0]
           print self.coords[0,:]
        self.guiUpdate()
    ...
    def clickTR(self):
        ...
        if self.debugging:
            ...
            self.coords[1,:] = [0.0261272718, 0.0377524465, 0]
            print self.coords[1,:]
        self.guiUpdate()
    ...
    def clickBL(self):
        ...
        if self.debugging:
            ...
            self.coords[2,:] = [0.023477405, 0.0459706698,0]
            print self.coords[2,:]
        self.guiUpdate()
    ...
    def clickBR(self):
        ...
        if self.debugging:
            ...
            self.coords[3,:] = [0.0268740829, 0.0456860997,0]
            print self.coords[3,:]
        self.guiUpdate()
